...
#define SI7210_SLOPT_BIT_SLTIMEENA      0
#define SI7210_SLOPT_BIT_SLFAST         1
...
#define SENSOR_ATTR_SI7210_USE_STORE (SENSOR_ATTR_PRIV_START+4)
#define SENSOR_ATTR_SI7210_SLEEP_TIME (SENSOR_ATTR_PRIV_START+5)
#define SENSOR_ATTR_SI7210_SLEEP_FAST (SENSOR_ATTR_PRIV_START+6)
#define SENSOR_ATTR_SI7210_ONEBURST (SENSOR_ATTR_PRIV_START+7)
