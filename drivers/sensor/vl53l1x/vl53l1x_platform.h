/* vl53l1x_platform.h - Zephyr customization of ST vl53l0x library.
 * (library is located in modules/hal/st/lib/sensor/vl53l1x/)
 */
 ...
 */
typedef struct {
	VL53L1X_DevData_t Data;    /* embed ST Ewok Dev  data as "Data"*/
	/*!< user specific field */
...
/**
 * @def PALDevDataGet
 * @brief Get ST private structure @a VL53L1X_DevData_t data access
 *
 ...
 * @brief  Set ST private structure @a VL53L1X_DevData_t data field
 * @param Dev       Device Handle
 * @param field     ST structure field name
